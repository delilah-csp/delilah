 ...
 * message will be stored in 'errmsg' and should be freed by the caller.
 */
int ubpf_load_elf(struct ubpf_vm* vm, const void* elf, size_t elf_len,
                  char** errmsg);

int ubpf_exec(const struct ubpf_vm* vm, void* mem, size_t mem_len,
 ...
 * message will be stored in 'errmsg' and should be freed by the caller.
 */
int ubpf_translate(struct ubpf_vm* vm, uint8_t* buffer, size_t* size,
                   char** errmsg);
